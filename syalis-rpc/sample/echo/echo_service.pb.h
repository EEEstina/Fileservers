...
namespace google {
namespace protobuf {
template<> ::syalis::rpc::echo::EchoRequest* Arena::CreateMaybeMessage<::syalis::rpc::echo::EchoRequest>(Arena*);
template<> ::syalis::rpc::echo::EchoResponse* Arena::CreateMaybeMessage<::syalis::rpc::echo::EchoResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace syalis {
namespace rpc {
...
class EchoRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:syalis.rpc.echo.EchoRequest) */ {
 public:
  EchoRequest();
  virtual ~EchoRequest();
  ...
  // @@protoc_insertion_point(class_scope:syalis.rpc.echo.EchoRequest)
 private:
...
class EchoResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:syalis.rpc.echo.EchoResponse) */ {
 public:
  EchoResponse();
  ...
  // @@protoc_insertion_point(class_scope:syalis.rpc.echo.EchoResponse)
 private:
...
inline const ::std::string& EchoRequest::message() const {
  // @@protoc_insertion_point(field_get:syalis.rpc.echo.EchoRequest.message)
  return message_.GetNoArena();
}
inline void EchoRequest::set_message(const ::std::string& value) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:syalis.rpc.echo.EchoRequest.message)
}
#if LANG_CXX11
inline void EchoRequest::set_message(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:syalis.rpc.echo.EchoRequest.message)
}
#endif
inline void EchoRequest::set_message(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:syalis.rpc.echo.EchoRequest.message)
}
inline void EchoRequest::set_message(const char* value, size_t size) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:syalis.rpc.echo.EchoRequest.message)
}
inline ::std::string* EchoRequest::mutable_message() {
  
  // @@protoc_insertion_point(field_mutable:syalis.rpc.echo.EchoRequest.message)
  return message_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* EchoRequest::release_message() {
  // @@protoc_insertion_point(field_release:syalis.rpc.echo.EchoRequest.message)
...
inline void EchoRequest::set_allocated_message(::std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:syalis.rpc.echo.EchoRequest.message)
}
...
inline const ::std::string& EchoResponse::message() const {
  // @@protoc_insertion_point(field_get:syalis.rpc.echo.EchoResponse.message)
  return message_.GetNoArena();
}
inline void EchoResponse::set_message(const ::std::string& value) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:syalis.rpc.echo.EchoResponse.message)
}
#if LANG_CXX11
inline void EchoResponse::set_message(::std::string&& value) {
  ...
  message_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:syalis.rpc.echo.EchoResponse.message)
}
#endif
inline void EchoResponse::set_message(const char* value) {
  ...
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:syalis.rpc.echo.EchoResponse.message)
}
inline void EchoResponse::set_message(const char* value, size_t size) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:syalis.rpc.echo.EchoResponse.message)
}
inline ::std::string* EchoResponse::mutable_message() {
  
  // @@protoc_insertion_point(field_mutable:syalis.rpc.echo.EchoResponse.message)
  return message_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* EchoResponse::release_message() {
  // @@protoc_insertion_point(field_release:syalis.rpc.echo.EchoResponse.message)
...
inline void EchoResponse::set_allocated_message(::std::string* message) {
  ...
  message_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), message);
  // @@protoc_insertion_point(field_set_allocated:syalis.rpc.echo.EchoResponse.message)
}
