...
using namespace syalis::rpc;

class EchoServerImpl : public syalis::rpc::echo::EchoServer {
public:
  EchoServerImpl() {}
...
private:
  virtual void Echo(google::protobuf::RpcController* controller,
                    const syalis::rpc::echo::EchoRequest* request,
                    syalis::rpc::echo::EchoResponse* response,
...
int main(int argc, char* argv[]) 
{
  ...
  syalis::rpc::echo::EchoServer* echo_service = new EchoServerImpl();
